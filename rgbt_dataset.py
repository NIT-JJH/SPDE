...
class SalObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, depth_root, bound_root,trainsize):
        ...
        self.bound_transform = transforms.Compose([
            # transforms.Resize((self.trainsize[0], self.trainsize)),
            transforms.ToTensor()])
...
def get_loader(image_root, gt_root, depth_root, bound_root,batchsize, trainsize, shuffle=True, num_workers=1, pin_memory=True):
...
class test_dataset:
    def __init__(self, image_root, gt_root, depth_root, testsize):
        ...
        self.transform = transforms.Compose([
            # transforms.Resize(self.testsize),
            transforms.ToTensor(),
            transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
